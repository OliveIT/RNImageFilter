...
public class RNColorMatrixImageFilter extends ReactViewGroup {
  ...
  public RNColorMatrixImageFilter(Context _context) {
    super(_context);
    context = _context;
  }
  ...
  public void draw(Canvas canvas) {
    ...
    for (int i = 0; i < this.getChildCount(); i++) {
      ...
      if (child instanceof ImageView) {
        ...
        if (_isTarget) {
            Log.e("AAAAAAAAAAA", "draw___________________target");
  ...
  public void fetchImage(ImageView view) {
    ...
    params.putString("data", imgString);

    reactContext
        .getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
        .emit("setImageBufferBase64", params);
