...
public class RNColorMatrixImageFilterManager extends ReactViewManager {
  ...
  protected static final String PROP_TARGET = "isTarget";
  protected static final String PROP_TARGETPATH = "targetPath";
  ...
  public void setTarget(RNColorMatrixImageFilter view, Boolean isTarget) {
    view.setTarget(isTarget);
  }

  @ReactProp(name = PROP_TARGETPATH)
  public void setTargetPath(RNColorMatrixImageFilter view, String targetPath) {
    view.setTargetPath(targetPath);
  }
}
